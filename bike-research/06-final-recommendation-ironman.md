# Final Recommendation — Alpe d'Huez Ironman Bike (€2,000–€3,000)

## The Short Answer

**Buy a new Cube Attain C:62 SLX (€2,499) + clip-on tri bars + bike fit.**

For Alpe d'Huez specifically, the official race recommendation is a road bike with clip-on tri bars. The Cube Attain C:62 SLX is the best value option that nails all requirements: comfort, climbing gears, disc brakes, and electronic shifting within budget.
...
**Why this wins:**
- 105 Di2 electronic shifting — no mis-shifts when exhausted
- Carbon frame + carbon cockpit — comfort over 180km
- 50/34 + 11-34 gearing (1:1 low gear) — climbs Alpe d'Huez
- Hydraulic disc brakes — safe alpine descents
- 6-year frame warranty
...
| Item | Cost |
|---|---|
| Used bike (2024-25) | ~€2,400 |
| Clip-on aero bars | €100 |
| New tyres + check-up | €150 |
| Professional bike fit | €200 |
| **Total** | **~€2,850** |

**Why consider it:**
- 8.2 kg (lighter than Cube's 8.4)
- 105 Di2 electronic shifting
- 35mm tyre clearance vs 34mm on Cube
- VCLS compliant seatpost (very comfortable)
- Slightly more race-oriented geometry

**Risks:** No warranty, condition unknown, harder to find/test in NL (Canyon is direct-sale only).
...
| Item | Cost |
|---|---|
| Used TT bike (e.g. Speedmax CF) | ~€2,500 |
| Gearing change (11-34 cassette) | €100 |
| New tyres + service | €200 |
| Bike fit (essential for tri position) | €200 |
| **Total** | **~€3,000** |

**Why NOT for Alpe d'Huez:**
- Heavier (9-10 kg) — extra 1-2 kg vs road bike uphill
- Aggressive position — hard on lower back for 5+ hours
- Limited gearing (52/36 + 11-28 common) — brutal on 13% gradients
- Rim brakes — less safe on long alpine descents
- Narrow tyres (25mm max) — less comfort and grip
- **The Alpe d'Huez organisers explicitly recommend against this**

**Only consider if:** This is your 2nd bike and you also race flat courses. Not ideal as a only bike for this race.
...
| Item | Cost |
|---|---|
| Used Attain C:62 Race | ~€1,400 |
| Clip-on aero bars | €100 |
| New tyres + service | €150 |
| Professional bike fit | €200 |
| **Total** | **~€1,850** |

**Why consider it:** Same frame as the SLX, mechanical 105 instead of Di2. €1,000 cheaper. Spend the savings on a good set of race wheels (e.g. used carbon wheels ~€500-800).
...
│   └─ Total: ~€2,800
│
├─ Used endurance road bike (€1,800-2,400)
│   ├─ Clip-on bars (€100)
│   ├─ Service/tyres (€150)
│   ├─ Bike fit (€200)
│   └─ Total: ~€2,250-2,850
│
└─ Used TT/tri bike (€2,000-3,000)
    ├─ Cassette swap (€100)
    ├─ Service/tyres (€200)
    ├─ Bike fit (€200)
    └─ Total: ~€2,500-3,500 ⚠️ over budget
```
